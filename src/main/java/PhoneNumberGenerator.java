...
public class PhoneNumberGenerator {
    public static void main(String[] args) {
        ...
        String first =  Integer.toString(rand.nextInt(7)) + rand.nextInt(7)+ rand.nextInt(7);
        // TODO: Generate second three digits (XXX) 
        // Constraint: Must be <= 742 (000-742)
        String second = Integer.toString(rand.nextInt(741));
        // TODO: Generate third three digits (XXX)
        // No constraints (000-999)
        String third = String.format("%03d",rand.nextInt(999));
